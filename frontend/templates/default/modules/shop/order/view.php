...
<div class="margin-top-30 box-light">
<!--=== Content Part ===-->
        <div class ="row">
                    ...
                    <?= \yii\widgets\DetailView::widget([
                        ...
                        'attributes' => [
                            ...
                            [                      // the owner name of the model
                                'label'     => 'Статус оплаты',
                                'format'    => 'raw',
                                'value'     => Html::tag('span', $model->payed == "Y" ? "Оплачен" : "Не оплачен", [
                                    'style' => 'color: '. ($model->payed == "Y" ? "green" : "red")
                                ]),
                            ],
                            [                      // the owner name of the model
                                'label'     => 'Статус',
                    ...
                    <div class="toggle active" style="display: block;">
                        <div class="toggle-content" style="display: block;">
                            ...
                            <? if ($model->allow_payment == "Y") : ?>
                                ...
                                <? if ($model->paySystem->paySystemHandler && $model->payed != "Y") : ?>
